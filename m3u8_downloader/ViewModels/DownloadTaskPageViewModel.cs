...
namespace m3u8_downloader.ViewModels
{
    public class DownloadTaskPageViewModel : BindableBase
    {
        ...
        private string _m3u8Url =
            "https://hls.qzkj.tech/videos5/5e7eefaa1bbf114dc2ce51399d437890/5e7eefaa1bbf114dc2ce51399d437890.m3u8?auth_key=1751084600-685f6e386a0bc-0-0ed441b561788ab194c54f5778ac694d&v=3&time=0";
        ...
        private async void ParseResourceAsync(DownloadTask task, string folder)
        {
            ...
            await indexedFiles.MergeTsSegmentsAsync(folder, task.TaskName, timeSpan.TotalSeconds,
                new Progress<double>(progress => { task.TaskState = $"合并中（{progress:F2}%）"; })
            );
